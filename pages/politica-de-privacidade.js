...
export default function PrivacyPolicy() {
  return (
    <main className={ styles.privacyPolicyPage }>
      <document className={ styles.privacyPolicyDoc }>
        ...
        <span>
          ...
          {' '}
          (“Website”) e o aplicativo “NG.CASH” (“Carteira Digital”), ambos fornecidos pela NG.CASH
          Serviços Financeiros Ltda., sociedade empresária limitada, situada na cidade do Rio de
          Janeiro, estado do Rio de Janeiro, na Rua Marquês de São Vicente, 225, Gávea, CEP 22451-
        ...
        <ol>
          ...
          <li>Como o NG.CASH usa as informações coletadas</li>
          <li>Como, quando e com quem o NG.CASH compartilha suas informações</li>
          <li>Quais direitos você tem sobre as informações que coletamos</li>
          <li>Como o NG.CASH protege suas informações</li>
        ...
        <ul>
          <li>
            Dados de cadastro de todos os usuários. Quando você se cadastra no NG.CASH, você
            nos fornece informações como login, senha, nome, endereço de e-mail, CPF, data de
            nascimento, estado civil, número de telefone, foto, idade, gênero, dados do cartão de
            crédito caso efetue pagamentos e dados de contas bancárias em outras instituições
            financeiras.
          </li>
          <li>
            Dados Adicionais para Menores de Idade. Dentre as informações coletadas pelo
            NG.CASH, os seguintes dados são coletados de menores de idade: Nome, CPF, RG,
            Endereço, idade, gênero, e-mail, localização. Esses dados, serão utilizados para criação
            da conta do usuário, seguindo as normas do Banco Central e das instituições de
            pagamento parceiras. Como nós do NG.CASH prezamos ainda mais pela proteção dos
            dados deste perfil de usuários, exigimos o consentimento específico e, em destaque,
            dado por pelo menos um dos pais ou responsáveis legais. Tal consentimento é
            garantido através da seguinte solução técnica: Cadastro dos dados, incluso e-mail, do
            Responsável e possibilidade de cadastro do cartão de crédito do Responsável.
          </li>
          <li>
            Informações de autenticação. Para lhe proporcionar um ambiente seguro, podemos
            pedir que você nos forneça informações de identificação (por exemplo, foto do
            documento de identidade e comprovante de residência) ou outras informações de
            autenticação (por exemplo, via SMS ou e-mail).
          </li>
          <li>
            Outras informações fornecidas. Ao utilizar certos recursos do NG.CASH,
            especialmente ao ultrapassar o limite de movimentação mensal definido pelo Banco
            Central para contas de pagamento ou operações que envolvam crédito, poderá ser
            solicitado informações adicionais como: (dados bancários adicionais, renda familiar,
            patrimônio pessoal, imposto de renda, contracheque e comprovante de residência.)
          </li>
        </ul>
        <br />
        ...
        <ul>
          <li>
            Registros de acesso. O NG.CASH coleta automaticamente registros de acesso a
            aplicação, que incluem o endereço IP, com data e hora, utilizado para acessar o
            NG.CASH. Esses dados são de coleta obrigatória, de acordo com a Lei 12.965/2014,
            mas somente serão fornecidos para terceiros com a sua autorização expressa ou por
            meio de demanda judicial.
          </li>
          <li>
            Dados de pagamento. Quando você realiza pagamentos no NG.CASH, poderão ser
            armazenados dados do pagamento, como a data e hora, o valor e outros detalhes da
            transação, que poderão ser utilizados inclusive para fins de prevenção à fraude. Desta
            forma, poderemos lhe proporcionar um ambiente seguro e adequado para você
            realizar as suas transações.
          </li>
          <li>
            Comunicações com o NG.CASH. Quando você se comunica com o NG.CASH, coletamos
            informações sobre sua comunicação, incluindo metadados como data, IP e hora das
            comunicações e todo o seu conteúdo, assim como qualquer informação que você
            escolha fornecer.
          </li>
          <li>
            Outras informações geradas. Ao utilizar certos recursos, o NG.CASH pode coletar
            informações geradas por você como: geolocalização, metadados do dispositivo de
            acesso aos serviços, áudios do seu microfone e fotos da sua câmera.
          </li>
        </ul>
        <br />
        ...
        <ul>
          <li>
            Dados coletados de outras plataformas. O NG.CASH poderá interagir com outras
            plataformas e outros serviços, como meios de pagamento. Alguns desses serviços
            podem nos fornecer informações sobre você para viabilizarmos a oferta de
            funcionalidades como assinaturas recorrentes pelo cartão de crédito, práticas de
            proteção antifraude, compra de créditos de jogos e serviços, pagamento de boletos,
            promoções em estabelecimentos, dentre outros.
          </li>
        </ul>
        <br />
        ...
        <ul>
          ...
          <li>
            Enviar a você mensagens a respeito de suporte ou serviço, como alertas, notificações
            e atualizações;
          </li>
          <li>
            Nos comunicar com você sobre produtos, serviços, promoções, notícias, atualizações,
            eventos e outros assuntos que você possa ter interesse;
          </li>
          ...
          <li>Criarmos novos serviços, produtos e funcionalidades;</li>
          <li>Detecção e prevenção de fraudes, spam e incidentes de segurança;</li>
          <li>
            Verificar ou autenticar as informações fornecidas por você, inclusive comparando a
            dados coletados de outras fontes;
          </li>
          <li>Entender melhor o comportamento do usuário e construir perfis comportamentais;</li>
          <li>
            Entender padrões de consumo para viabilizar ofertas especiais aos nossos usuários,
            junto a estabelecimentos comerciais parceiros;
          </li>
        ...
        <span>
          ...
          para a sua manutenção, como eventual obrigação legal de retenção de dados ou necessidade
        ...
        <span>
          ...
          expressamente tais compartilhamentos, em especial, mas não se limitando ao
        ...
        <span>
          ...
          dos dados que você nos fornece. Você pode retificar diretamente alguns dos seus dados
          pessoais através do e-mail
          {' '}
          <a href="mailTo:suporte@ng.cash" target="_blank" rel="noreferrer">suporte@ng.cash</a>
          {' '}
          .
        ...
        <span>
          ...
          ou relevantes para lhe oferecermos nossos serviços, salvo se houver qualquer outra razão
          para a sua manutenção, como eventual obrigação legal de retenção de dados ou necessidade
          de preservação destes para resguardo de direitos da NG.CASH. Para alterar suas informações
          pessoais ou excluí-las do nosso banco de dados, basta enviar um e-mail para
          {' '}
          <a href="mailTo:suporte@ng.cash" target="_blank" rel="noreferrer">suporte@ng.cash</a>
          {' '}
          .
        ...
        <span>
          ...
          precisar que sejam mantidos os dados mesmo se não precisarmos mais deles, conforme
        ...
        <span>
          ...
          perfis pessoais, profissionais, de consumo e de crédito e/ou os aspectos de sua personalidade.
          Talvez seja necessário solicitar informações específicas suas para nos ajudar a confirmar sua
          identidade e garantir seu direito de acessar seus dados pessoais (ou de exercer seus outros
          direitos). Esta é uma medida de segurança para garantir que os dados pessoais não sejam
        ...
        <span>
          ...
          principalmente caso haja compartilhamento indevido das credenciais necessárias para
          acessar o nosso aplicativo. Portanto, você é o único responsável por manter sua senha de
          acesso em local seguro e é vedado o compartilhamento desta com terceiros. Você se
